...
## Результаты нагрузочного тестирования (дополнительное задание)
Тестирование можно запустить командой: make load-test

### Конфигурация теста
- **Сценарий**: Постепенное увеличение нагрузки с последующим спадом
- **Продолжительность**: 1 минута 20 секунд
- **Максимальное количество VU (Virtual Users)**: 4
- **Этапы**:
  - 10s: плавный рост до 4 VU
  - 1m: стабильная нагрузка 4 VU  
  - 10s: плавное снижение до 0 VU

### Ключевые метрики производительности

| Метрика | Результат |
|---------|-----------|
| **HTTP Request Duration (p95)** | 8.03 ms
| **HTTP Request Failed Rate** | 0.00% |
| **HTTP Requests Rate** | 71.23 req/s |
